...
extension StockDetailsView {
    ...
    func setDetailsSymbolLabel(){
        ...
        stockDetailsSymbolLabel.setWidth(width: 50)
    }
    func setStockDetailsPriceLabel(){
        ...
        stockDetailsPriceLabel.setWidth(width: 50)
    }
    ...
    func setStockDetailsDifferenceLabel(){
        ...
        stockDetailsDifferenceLabel.setWidth(width: 50)
    }
    func setStockDetailsVolumeLabel(){
        ...
        stockDetailsVolumeLabel.setWidth(width: 50)
    }
    ...
    func setStockDetailsBidLabel(){
        ...
        stockDetailsBidLabel.setWidth(width: 50)
    }
    ...
    func setStockDetailsOfferLabel(){
        ...
        stockDetailsOfferLabel.setWidth(width: 50)
    }
    ...
    func setStockDetailsMaximumLabel(){
        ...
        stockDetailsMaximumLabel.setWidth(width: 50)
    }
    ...
    func setStockDetailsCountLabel(){
        ...
        stockDetailsCountLabel.setWidth(width: 50)
    ...
    func setStockDetailsHighestLabel(){
        ...
        stockDetailsHighestLabel.setWidth(width: 50)
    }
    ...
    func setStockDetailsLowestLabel(){
        ...
        stockDetailsLowestLabel.setWidth(width: 50)
    }
    ...
    func setStockDetailsVariationLabel(){
        ...
        stockDetailsVariationLabel.setWidth(width: 50)
    }
